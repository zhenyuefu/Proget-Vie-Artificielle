            ...
            for x in range (0,len(self.Map_trees[0])):
                ...
                for y in range(0,len(self.Map_trees)):
                    ...
                    if self.Map_mountains[y][x]==1:
                        ...
                        if self.Map_mountains[y_mx][x]==0: 

                            # Ouest

                            if self.Map_mountains[y][x_mn]==0:
                            ...
                            if self.Map_mountains[y][x_mx]==0:
                        ...
                        if self.Map_mountains[y_mn][x]==0: 
                        ...
                        if self.Map_mountains[y_mx][x_mx]==0:

                            if self.Map_mountains[y_mx][x]==1 and self.Map_mountains[y][x_mx]==1:

                                self.screen.blit(self.green_corner_SE,(x*self.size_tile_X,y*self.size_tile_Y))

                                continue

                        if self.Map_mountains[y_mx][x_mn]==0:

                            if self.Map_mountains[y_mx][x]==1 and self.Map_mountains[y][x_mn]==1:

                                self.screen.blit(self.green_corner_SW,(x*self.size_tile_X,y*self.size_tile_Y))

                                continue

                        if self.Map_mountains[y_mn][x_mn]==0:

                            if self.Map_mountains[y_mn][x]==1 and self.Map_mountains[y][x_mn]==1:

                                self.screen.blit(self.green_corner_NW,(x*self.size_tile_X,y*self.size_tile_Y))

                                continue

                        if self.Map_mountains[y_mn][x_mx]==0:

                            if self.Map_mountains[y_mn][x]==1 and self.Map_mountains[y][x_mx]==1:
